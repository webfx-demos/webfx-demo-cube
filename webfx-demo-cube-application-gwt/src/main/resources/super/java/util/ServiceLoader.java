...
public class ServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> ServiceLoader<S> load(Class<S> serviceClass) {
        switch (serviceClass.getName()) {
            ...
            case "dev.webfx.kit.webgl.spi.WebGLProvider": return new ServiceLoader<S>(dev.webfx.kit.webgl.spi.impl.gwtj2cl.GwtJ2clWebGLProvider::new);
            ...
            case "dev.webfx.platform.resource.spi.impl.gwt.GwtResourceBundle": return new ServiceLoader<S>(webfx.demo.cube.application.gwt.embed.EmbedResourcesBundle.ProvidedGwtResourceBundle::new);
            ...
            case "dev.webfx.platform.typedarray.spi.TypedArrayFactoryProvider": return new ServiceLoader<S>(dev.webfx.platform.typedarray.spi.impl.gwtj2cl.GwtJ2clTypedArrayFactoryProvider::new);
            ...
            case "javafx.application.Application": return new ServiceLoader<S>(dev.webfx.demo.cube.CubeApplication::new);
