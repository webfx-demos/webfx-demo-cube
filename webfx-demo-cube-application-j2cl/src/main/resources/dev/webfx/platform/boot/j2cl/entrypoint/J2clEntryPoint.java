...
public final class J2clEntryPoint {
    ...
    public static void registerServiceProviders() {
        ...
        register(dev.webfx.kit.webgl.spi.WebGLProvider.class, dev.webfx.kit.webgl.spi.impl.gwtj2cl.GwtJ2clWebGLProvider::new);
        ...
        register(dev.webfx.platform.typedarray.spi.TypedArrayFactoryProvider.class, dev.webfx.platform.typedarray.spi.impl.gwtj2cl.GwtJ2clTypedArrayFactoryProvider::new);
        ...
        register(javafx.application.Application.class, dev.webfx.demo.cube.CubeApplication::new);
    }
}